export default function Footer() {
  return (
    <footer className="border-t border-dark-700/50 bg-dark-900/30">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              ...
              Da integração ao atendimento automatizado.
            </p>
            <div className="flex gap-3 mt-4">
              {/* GitHub */}
              <a
                href="#"
                className="w-9 h-9 rounded-lg bg-dark-700/60 border border-dark-600 flex items-center justify-center text-slate-400 hover:text-white hover:border-dark-500 transition-colors"
                aria-label="GitHub"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5">
              {["Funcionalidades", "Como funciona", "Planos", "Changelog"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5">
              {["Documentação", "API Reference", "Status", "Contato"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-slate-400 hover:text-white transition-colors">
                    {item}
                  </a>
        ...
        <div className="pt-8 border-t border-dark-700/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} Zapnit. Todos os direitos reservados.
          </p>
